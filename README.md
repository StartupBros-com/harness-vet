...
That second result is the skill's core claim in miniature: even when the answer is "don't install it," a real vet returns value — the audit dividend section exists because in practice it sometimes outvalues the verdict.
